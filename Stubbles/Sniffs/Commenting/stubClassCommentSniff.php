<?php
/**
 * This sniff checks for class docblocks
 *
 * @author   Richard Sternagel <richard.sternagel@1und1.de>
 * @package  Commenting
 */

require_once('stubFileCommentSniff.php');

if (class_exists('PHP_CodeSniffer_CommentParser_ClassCommentParser', true) === false) {
    throw new PHP_CodeSniffer_Exception('Class PHP_CodeSniffer_CommentParser_ClassCommentParser not found');
}

if (class_exists('Stubbles_Sniffs_Commenting_stubFileCommentSniff', true) === false) {
    throw new PHP_CodeSniffer_Exception('Class Stubbles_Sniffs_Commenting_stubFileCommentSniff not found');
}
...
class Stubbles_Sniffs_Commenting_stubClassCommentSniff extends Stubbles_Sniffs_Commenting_stubFileCommentSniff
{
    /**
